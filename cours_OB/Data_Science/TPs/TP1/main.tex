...
\begin{enumerate}
    ...
    \item Let’s consider $u = (u_i)_{1 \leq i \leq 7}$ and $v = (v_i)_{1 \leq i \leq 7}$, two vectors of length 7.
...
% \url{https://moodle.unige.ch} before \textcolor{red}{Monday, October 9 2023, 21:59 PM}. \\
