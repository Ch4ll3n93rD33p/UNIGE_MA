...
###### Flow definition #########################################################
maxIter = 12000  # Total number of time iterations. 200000
Re = 10.0        # Reynolds number.
# Von Karman vortices
# Re = 220.0
nx, ny = 420, 180 # Number of lattice nodes.
ly = ny-1         # Height of the domain in lattice units.
cx, cy, r = nx//4, ny//4, ny//9 # Coordinates of the cylinder. nx//4, ny//2, ny//9
cx2, cy2 = cx, 3*ny//4
...
def obstacle_fun(x, y):
    return (x-cx)**2+(y-cy)**2<r**2 # cylinder

def obstacle_fun2(x, y):
    return (x-cx2)**2+(y-cy2)**2<r**2 # cylinder
    #return (x-cx<r and y-cy<2*r)# TODO

obstacle = fromfunction(obstacle_fun, (nx,ny)) + fromfunction(obstacle_fun2, (nx,ny)) # TODO double obstacle
...
for time in range(maxIter):
    ...
    # Bounce-back condition for walls #TODO
    #for i in range(9):
        #fout[i, ] = fin[8-i, ]
