...
class ADTTests: XCTestCase {
  ...
  func testSetNeedForEqual(){
    ...
    let s3 = Set.n([Nat.n(1), Nat.n(4), Nat.n(7), Nat.n(10)])
    ...
    // removeOne({1,4,7,10}, 7) = {1,4,10}
    self.TAssert(Set.removeOne(s3, Nat.n(7)), Set.n([Nat.n(1), Nat.n(4), Nat.n(10)]))
  }
  ...
  func testSetEqual(){
    ...
    let s4 = Set.n([Nat.n(6), Nat.n(7), Nat.n(8)])
    ...
    self.TAssert(Set.eq(s1, s4), Boolean.False())
  }
  ...
  func testSet(){
    ...
    let s5 = Set.n([Nat.n(1), Nat.n(2), Nat.n(3)])
    ...
    // intersection({},{20,30}) = {}
    self.TAssert(Set.eq(Set.intersection(Set.empty(), s3), Set.empty()), Boolean.True())
    // intersection({20,30},{}) = {}
    self.TAssert(Set.eq(Set.intersection(s3, Set.empty()), Set.empty()), Boolean.True())
    ...
    // diff({1,2,4,10}, {1,2,4,10}) = {}
    self.TAssert(Set.eq(Set.diff(s1,s1), Set.empty()), Boolean.True())
    ...
    // subSet({1,2,4,10},{}) = False
    self.TAssert(Set.subSet(s1, Set.empty()), Boolean.False())
    // subSet({1,2,3}, {1,2,4,10}) = False
    self.TAssert(Set.subSet(s5,s1), Boolean.False())
