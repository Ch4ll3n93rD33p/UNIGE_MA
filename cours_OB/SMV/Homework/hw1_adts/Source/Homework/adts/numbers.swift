...
public class Integer: ADT{
 ...
 // TODO: sub (substraction)
    ...
    self.add_operator("abs", Integer.abs, [
      Rule(Integer.abs(Integer.int(Variable(named: "x"), Nat.zero())), Variable(named: "x")), // abs(x-0) = x
      Rule(Integer.abs(Integer.int(Nat.zero(),Variable(named: "x"))), Variable(named: "x")), // abs(0-x) = x
      Rule(
              Integer.abs(Integer.int(Variable(named: "x"), Variable(named: "y"))),
              Nat.sub(Variable(named: "x"), Variable(named: "y")),
              Boolean.or(Nat.gt(Variable(named: "x"), Variable(named: "y")), Nat.eq(Variable(named: "x"), Variable(named: "y")))), // case x>=y : abs(x-y) = ((x-y)-0)
      Rule(
              Integer.abs(Integer.int(Variable(named: "x"), Variable(named: "y"))),
              Nat.sub(Variable(named: "y"), Variable(named: "x")),
              Nat.lt(Variable(named: "x"), Variable(named: "y"))
    ...
    self.add_operator("normalize", Integer.normalize, [
        ...
        Rule(
                ...
                Integer.int(Integer.abs(Variable(named: "x"), Variable(named: "y")), Nat.zero()),
                Boolean.or(Nat.gt(Variable(named: "x"), Variable(named: "y")), Nat.eq(Variable(named: "x"), Variable(named: "y")))
        ), // case x>=y : norm(x,y) = (abs(x-y)-0)
        Rule(
                Integer.normalize(Integer.int(Variable(named: "x"), Variable(named: "y"))),
                Integer.int(Nat.zero(), Integer.abs(Variable(named: "y"), Variable(named: "x"))),
                Nat.lt(Variable(named: "x"), Variable(named: "y"))
        ) // case x<y : norm(x,y) = (0-abs(x-y))
    ], ["int"])
    ...
    self.add_operator("*", Integer.mul, [
      Rule(
              ...
              Integer.int(Nat.add(Nat.mul(Variable(named: "a"), Variable(named: "c")), Nat.mul(Variable(named: "b"), Variable(named: "d"))), Nat.add(Nat.mul(Variable(named: "a"), Variable(named: "d")), Nat.mul(Variable(named: "b"), Variable(named: "c"))))
    ...
    self.add_operator("/", Integer.div, [
      Rule(Integer.div(Integer.int(Variable(named: "a"), Variable(named: "b")), Integer.int(Variable(named: "c"), Variable(named: "d"))), vFail, Nat.eq(Variable(named: "c"), Variable(named: "d"))), // div by 0 not defined
      Rule(
              Integer.div(Integer.int(Variable(named: "a"), Variable(named: "b")), Integer.int(Variable(named: "c"), Variable(named: "d"))),
              Integer.int(Nat.zero(), Nat.div(Integer.abs(Variable(named: "a"), Variable(named: "b")), Integer.abs(Variable(named: "c"), Variable(named: "d")))),
              Boolean.not(Boolean.eq(Integer.sign(Integer.int(Variable(named: "a"), Variable(named: "b"))), Integer.sign(Integer.int(Variable(named: "c"), Variable(named: "d")))))
      ), // case a<b xor c<d : (a-b)/(c-d) = (0-(abs(a-b)/abs(c-d)))
      Rule(
              Integer.div(Integer.int(Variable(named: "a"), Variable(named: "b")), Integer.int(Variable(named: "c"), Variable(named: "d"))),
              Integer.int(Nat.div(Integer.abs(Variable(named: "a"), Variable(named: "b")), Integer.abs(Variable(named: "c"), Variable(named: "d"))), Nat.zero()),
              Boolean.eq(Integer.sign(Integer.int(Variable(named: "a"), Variable(named: "b"))), Integer.sign(Integer.int(Variable(named: "c"), Variable(named: "d"))))
      ) // case !(a<b xor c<d) : (a-b)/(c-d) = (((a-b)/(c-d))-0)
    ], ["int", "int"])
  }
